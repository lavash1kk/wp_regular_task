...
<div class="main-content">
    ...
    <div class="right-content">
        <div class="imgage-content">
            <img src="<?php get_template_directory_uri(); ?>/images/man_img.png" alt="John Doe">
        </div>
    </div>
</div>
...
<div class="body-content">
    <div class="banner-content">
        ...
        <div class="banner-right-content">
            <img src="<?php get_template_directory_uri(); ?>/images/img_devices.png" alt="Devices">
        </div>
    </div>
</div>
    ...
    <div class="slider-block">
        ...
        <div class="middle-content">
            <div class="image-middle-content">
                <img src="images/img_for_comments.png" alt="Comments">
            </div>
